...
import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, E as stores$1, o as onMount, Q as onDestroy, t as track, f as element, l as claim_element, m as children, h as detach_dev, r as attr_dev, p as add_location, u as insert_dev, y as listen_dev, Z as prop_dev, b as binding_callbacks, a as bind, c as space, e as create_component, g as text, q as query_selector_all, j as claim_space, k as claim_component, n as claim_text, T as set_style, w as mount_component, x as append_dev, $ as prevent_default, z as add_flush_callback, A as transition_in, B as transition_out, C as destroy_component, a0 as run_all, P as globals, V as set_data_dev, H as noop } from './client.f1312861.js';
import { u as util, M as Markmap_1, l as lodash_debounce, t as transform_1 } from './markmap.29b8b345.js';
import { H as Header, F as Footer } from './footer.a6658d63.js';
import { T as Toolbar_1, s as subscribeHash } from './gist.ebc87685.js';
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 156, 6, 4276);
			...
			add_location(input, file, 157, 6, 4319);
			attr_dev(a0, "class", "ml-2 no-underline");
			add_location(a0, file, 158, 6, 4450);
			attr_dev(a1, "class", "ml-2 no-underline");
			add_location(a1, file, 159, 6, 4539);
			attr_dev(form, "class", "flex");
			add_location(form, file, 155, 4, 4208);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(a, file, 153, 4, 4133);
		},
		m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 161, 8, 4655);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(textarea, file, 169, 6, 4884);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file, 141, 2, 3757);
			attr_dev(div0, "class", "fixed z-10 hidden md:block");
			set_style(div0, "top", "15px");
			set_style(div0, "left", "50%");
			add_location(div0, file, 140, 0, 3688);
			attr_dev(div1, "class", "flex items-center mb-4 text-sm");
			add_location(div1, file, 151, 2, 4068);
			attr_dev(div2, "class", "flex-1 min-w-0 border border-gray-300");
			add_location(div2, file, 167, 4, 4789);
			attr_dev(div3, "class", "markmap-wrapper flex-1");
			add_location(div3, file, 173, 6, 5038);
			add_location(a1, file, 186, 10, 5360);
			attr_dev(div4, "class", "inline-block px-4 py-2");
			add_location(div4, file, 185, 8, 5313);
			add_location(a2, file, 189, 10, 5563);
			attr_dev(span, "class", "text-red-500");
			add_location(span, file, 190, 10, 5636);
			attr_dev(div5, "class", "inline-block px-4 py-2");
			attr_dev(div5, "title", "SVG does not work well with PrismJS and MathJax");
			add_location(div5, file, 188, 8, 5460);
			add_location(div6, file, 184, 6, 5299);
			attr_dev(div7, "class", "flex-1 min-w-0 flex flex-col");
			add_location(div7, file, 172, 4, 4989);
			attr_dev(div8, "class", "md:fs md:flex repl");
			add_location(div8, file, 166, 2, 4752);
			attr_dev(main, "class", "inner flex flex-col");
			add_location(main, file, 150, 0, 4031);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		...
		const { default: CodeMirror } = await Promise.all([import('./codemirror.61272ef7.js'), __inject_styles(["client-ff2bd8be.css","codemirror-8033c53c.css"])]).then(function(x) { return x[0]; });
